...
export const SearchAndFilters: React.FC<SearchAndFiltersProps> = React.memo(
  ({
    ...
    // Ref pour maintenir le focus de l'input
    const inputRef = useRef<HTMLInputElement>(null);
    const wasFocusedRef = useRef(false);

    // Sauvegarder l'état de focus avant re-render et le restaurer après
    useEffect(() => {
    ...
    const handleInputChange = (e: React.ChangeEvent<HTMLInputElement>) => {
      // Marquer que l'input était focusé
    ...
    const handleClearAll = () => {
      onSearchChange("");
      onRoleFilterChange && onRoleFilterChange("TOUS");
