...
export const register = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    logAuthEvent("REGISTER_ERROR", email, ip, userAgent, error.message);
...
export const login = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    logAuthEvent("LOGIN_ERROR", email, ip, userAgent, error.message);
...
export const me = async (req: Request, res: Response): Promise<void> => {
  ...
  try {
    ...
    logAuthEvent("ME_ERROR", req.user?.email || "unknown", ip, userAgent, error.message);
